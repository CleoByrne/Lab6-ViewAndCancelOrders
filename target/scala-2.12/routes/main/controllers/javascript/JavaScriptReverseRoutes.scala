...
package controllers.javascript {
  ...
  class ReverseShoppingCtrl(_prefix: => String) {
    ...
    def cancelOrder: JavaScriptReverseRoute = JavaScriptReverseRoute(
      ...
      """
        function(orderId0) {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "cancelOrder/" + encodeURIComponent((""" + implicitly[play.api.mvc.PathBindable[Long]].javascriptUnbind + """)("orderId", orderId0))})
        }
      """
    )
